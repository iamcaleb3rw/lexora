...
import { ChevronsLeft, PanelLeftIcon, PanelRight } from "lucide-react";
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-red-400 text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-150 ease-in md:flex",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {state === "expanded" ? <ChevronsLeft /> : <PanelRight />}
